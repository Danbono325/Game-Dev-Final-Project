...
//Hope Davis
//Main Menu Screen with instructions and play option
...
public class MainMenuScreen implements Screen{
    ...
    //Texture for instructions button
    Texture instructions;

    //Texture for play button
    Texture play;
    ...
    public void render(float delta) {
        ...
        if(Gdx.input.isTouched()) {
            ...
            //to see if instructions button is clicked
            ...
            //to see if play button is clicked
